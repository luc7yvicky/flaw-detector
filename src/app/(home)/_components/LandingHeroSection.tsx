...
export default function LandingHeroSection({
  ...
  return (
    <section
      className="flex-col-center-center snap-box relative min-h-[calc(100dvh-8.5rem)] gap-y-5 text-[3.75rem] leading-[4.538rem] tracking-[0.015em] text-primary-500"
      id="hero"
    >
      ...
      <h1 className="rounded-full border-4 border-primary-500 bg-white px-10 py-[1.156rem]">
        FlawDetector
      </h1>
      <p className="word-break-phrase mb-10 mt-4 text-center text-[1.5rem]">
